...
public class CardGameFinal {
	...
	// 숫자,JQK 변환 로직 메소드
	public static int convert(String card_num,int sum) {
		...
		case "2": case "3": case "4": case "5": case "6": case "7": case "8": case "9":
			num = Integer.parseInt(card_num);// 형 변환
			break;// **
	...
	public static void main(String[] args) {
		...
		CardGameFinal cgf = new CardGameFinal();

		System.out.println("블랙잭 게임을 시작합니다. ( 게임을 종료하려면 숫자 0을 입력하세요 ) ");
		...
		while (money>0) {
			...
			if (inputNum > money) {
				System.out.println("자산 보다 높게 베팅할 수 없습니다. 다시 입력해주세요.");
				System.out.println();
				System.out.print("얼마를 베팅하시겠습니까? ");
				inputNum = in.nextInt();
			}
